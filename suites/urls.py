...
urlpatterns = [
    ...
    path('<uuid:suite_id>/schedule/', views.save_schedule, name='suite_save_schedule'),
    path('<uuid:suite_id>/schedule/delete/', views.delete_schedule, name='suite_delete_schedule'),
